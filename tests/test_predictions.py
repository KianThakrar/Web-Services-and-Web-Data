...
def register_and_login(client):
    client.post("/api/v1/auth/register", json={"username": "pred_user", "email": "p@test.com", "password": "pass123"})
    resp = client.post("/api/v1/auth/login", data={"username": "pred_user", "password": "pass123"})
